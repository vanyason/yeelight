    ...
    <div className="h-screen flex flex-col bg-gradient-to-tr from-slate-900 to-fuchsia-900 text-cyan-200 font-mono">
      ...
      <div className="com outline-sky-500 basis-7/12 flex">
        <div className="com outline-orange-300 basis-2/5 flex flex-col items-center justify-around">
          <div className="com outline-green-300 basis-5/6 flex items-center justify-center">{" Bulb here "}</div>
          <BulbToggle />
        </div>
        <div className="com outline-orange-300 basis-3/5 flex items-center justify-center">{" logs here "}</div>
      </div>
      {/* II section */}
      <div className="com outline-sky-500 basis-4/12 flex justify-around">
        <div className="com outline-orange-300 flex items-center justify-center basis-5/12">{" Color picker "}</div>
        <div className="com outline-orange-300 flex items-center justify-center basis-5/12">{" Temp picker picker "}</div>
        <div className="com outline-orange-300 flex items-center justify-center basis-1/12">{" Bright picker "}</div>
      </div>
      {/* III section */}
